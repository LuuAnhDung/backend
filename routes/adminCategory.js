...
// GET ALL CATEGORIES
router.get("/categories/get-all", adminCategoriesController.getAllCategories);

// GET CATEGORY
router.get("/categories/single/:categoryId", isAuth, adminCategoriesController.getCategory);
...
// PUT CATE
router.put(
  "/categories/category/update/:categoryId",
  isAuth,
  isAdmin,
  uploadMiddleware.single("cateImage"),
  body("name")
...
// DELETE CATE
router.delete("/categories/category/delete/:categoryId", isAuth, isAdmin, adminCategoriesController.deleteCategory);
